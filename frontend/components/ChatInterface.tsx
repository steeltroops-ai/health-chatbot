        ...
        <form onSubmit={handleSendMessage} className="flex items-end gap-2">
          <div className="flex-1 min-w-0">
            <textarea
              ...
              className="block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm resize-none overflow-hidden bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
